...
SX1302_RESET_PIN=5 # SX1302 reset channge to 5 for openwrt mt7628 platform - board
# SX1302_RESET_PIN=78 # SX1302 reset channge to 5 for openwrt quectel gps platform - board
# SX1302_POWER_EN_PIN=18  # SX1302 power enable
# SX1261_RESET_PIN=22     # SX1261 reset (LBT / Spectral Scan)
# AD5338R_RESET_PIN=13    # AD5338R reset (full-duplex CN490 reference design)

WAIT_GPIO() {
	sleep 1 # default 0.1s
}
...
term() {
	...
	if [ -d /sys/class/gpio/gpio$SX1302_RESET_PIN ]; then
		echo "$SX1302_RESET_PIN" >/sys/class/gpio/unexport
		WAIT_GPIO
	fi
